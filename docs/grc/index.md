...
*This image won't show and I don't know why but it'll go away eventually. Still need to figure out how to embed or link to stable viewing environment*
...
*Analysis:* **more to come!** the patterns we (HWW) see… betweenness centrality—climate change node indirectly connected to humanities in a changing climate node via the projects…other types of centrality…biggest foci of each theme…biggest foci in general
